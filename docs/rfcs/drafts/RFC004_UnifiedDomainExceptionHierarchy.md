...
| **`LunoRateLimitException`** | `ErrTooManyRequests`, `ErrAddressCreateRateLimitReached`, `ErrActiveCryptoRequestExists`, `ErrMaxActiveFiatRequestsExists` |
