...
public static class LunoMarketExtensions
{
    ...
    public static IAsyncEnumerable<TickerResponse> ListTickersAsync(
        this ILunoClient client, 
        CancellationToken ct = default)
    {
        var handler = new ListTickersHandler(client.Market);
        return handler.HandleAsync(new ListTickersQuery(), ct);
    }
}
